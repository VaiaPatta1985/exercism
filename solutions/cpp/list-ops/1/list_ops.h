...
template<typename T> void append(std::vector<T>& v1, std::vector<T> v2) {//wtf
...
/*template<typename T, typename S, typename L> std::vector<S> map(std::vector<T> v,
                                                    L lam) {
...
template<typename T, typename L> std::vector<T> map(std::vector<T> v,
                                                    L lam) {
